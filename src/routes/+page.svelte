...
<div class="max-w-3xl px-8 mx-auto overflow-x-hidden">
	<section class="mt-40">
		...
		<p class="sm:w-[80%] mt-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Delectus, ipsa architecto incidunt nesciunt obcaecati at inventore fugiat eum.</p>
	...
	<section>
		...
		<p class="mt-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Natus, facilis maiores? Fugit est consectetur molestias.</p>

		<ul class="grid sm:grid-cols-2 gap-4 mt-4">
			<Contact title="maongoose#8934" color="bg-indigo-500">
			...
			<Contact title="+44 7563 845940" url="https://wa.me/447563845940" color="bg-yellow-400">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5"><path fill-rule="evenodd" d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z" clip-rule="evenodd" /></svg>
			</Contact>
		</ul>
	</section>
	...
	<footer class="flex justify-center mb-8">
		© 2023 Daniel George |&nbsp;<a class="hover:underline" href="https://www.github.com/othema/portfolio">Built with Svelte and TailwindCSS</a>
	</footer>
</div>